...
namespace ychitel {
    ...
    public partial class adminDataSet : global::System.Data.DataSet {
        ...
        public partial class УчителяDataTable : global::System.Data.TypedTableBase<УчителяRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public УчителяRow AddУчителяRow(string Логин, string Пароль) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public УчителяRow FindByКод(int Код) {
        ...
        public partial class УчителяRow : global::System.Data.DataRow {
            ...
            public int Код {
                get {
                    return ((int)(this[this.tableУчителя.КодColumn]));
                }
                set {
                    this[this.tableУчителя.КодColumn] = value;
                }
            }
            ...
            public string Логин {
                get {
                    try {
                        return ((string)(this[this.tableУчителя.ЛогинColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Логин\' в таблице \'Учителя\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableУчителя.ЛогинColumn] = value;
                }
            }
            ...
            public string Пароль {
                get {
                    try {
                        return ((string)(this[this.tableУчителя.ПарольColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Пароль\' в таблице \'Учителя\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableУчителя.ПарольColumn] = value;
                }
            }
            ...
            public bool IsЛогинNull() {
                return this.IsNull(this.tableУчителя.ЛогинColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetЛогинNull() {
                this[this.tableУчителя.ЛогинColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public bool IsПарольNull() {
                return this.IsNull(this.tableУчителя.ПарольColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetПарольNull() {
                this[this.tableУчителя.ПарольColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace ychitel.adminDataSetTableAdapters {
    ...
    public partial class УчителяTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Учителя` WHERE ((`Код` = ?) AND ((? = 1 AND `Логин` IS NULL) OR (`Ло" +
                "гин` = ?)) AND ((? = 1 AND `Пароль` IS NULL) OR (`Пароль` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Учителя` (`Логин`, `Пароль`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Учителя` SET `Логин` = ?, `Пароль` = ? WHERE ((`Код` = ?) AND ((? = 1 AND" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ychitel.Properties.Settings.Default.adminConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Код, Логин, Пароль FROM Учителя";
        ...
        public virtual int Fill(adminDataSet.УчителяDataTable dataTable) {
        ...
        public virtual adminDataSet.УчителяDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            adminDataSet.УчителяDataTable dataTable = new adminDataSet.УчителяDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(adminDataSet.УчителяDataTable dataTable) {
